...
categories = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/categories.csv', sep=';')
customers = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/customers.csv', sep=';')
employee_territories = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/employee_territories.csv', sep=';')
employees = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/employees.csv', sep=';')
order_details = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/order_details.csv', sep=';')
orders = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/orders.csv', sep=';')
products = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/products.csv', sep=';')
region = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/region.csv', sep=';')
shippers = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/shippers.csv', sep=';')
suppliers = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/suppliers.csv', sep=';')
territories = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/territories.csv', sep=';')
us_states = pd.read_csv(r'C:/Users/mtuli/Desktop/northwind (3)/us_states.csv', sep=';')
